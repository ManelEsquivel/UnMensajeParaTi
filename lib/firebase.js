// lib/firebase.js (VERSION FINAL DE CONEXIÓN ROBUSTA)
...
if (process.env.FIREBASE_PRIVATE_KEY_STRING && !admin.apps.length) {
    ...
    // ⚠️ Construcción del objeto de credenciales a partir de las variables de entorno simples.
    // Usamos las variables nuevas y valores estáticos de tu JSON original.
    const adminConfig = {
