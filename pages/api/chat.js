...
// --- LA REGLA 1 (Pedir Nombre) HA SIDO ELIMINADA Y MOVIDA A 4.B ---
...
3.  **Respuesta Final de Confirmación (Coincidencia Única General):**
        ...
        * **Si el estado es PENDIENTE:** "¡Sí, [Nombre] [Apellido], estás en la lista de invitados! Sin embargo, tu asistencia se encuentra **PENDIENTE** de confirmación. Por favor, confírmala en la web: [Confirmar Asistencia Aquí](${urlConfirmacionInPrompt}). ¡Te esperamos con mucha ilusión!. **AVISO:** Una vez confirmada tu asistencia en el enlace, los cambios pueden tardar hasta 24 horas en reflejarse en este asistente."
