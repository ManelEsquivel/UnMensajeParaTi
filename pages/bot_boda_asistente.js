...
export default function ImagenesBoda() {
    ...
    // --- MANEJO DE CLIC ROBUSTO (Móvil y Desktop) ---
    const handleLoadMore = (e) => { 
        // Si existe el evento (puede no existir si lo llamamos manualmente), lo paramos
        ...
        <div style={styles.pageContainer}>
            ...
            <div style={styles.galleryContainer}>
                ...
                {nextPageToken && (
                    <button 
                        type="button" 
                        /* 👇 AQUÍ ESTÁ EL TRUCO: onTouchEnd responde instantáneo en móvil */
                        onTouchEnd={(e) => { e.preventDefault(); handleLoadMore(); }}
                        onClick={handleLoadMore} /* onClick para PC */
...
const styles = {
    ...
    loadMoreBtn: { 
        ...
        fontSize: '14px', 
        cursor: 'pointer',
        // ESTO EVITA EL PARPADEO GRIS Y LA SELECCIÓN
        WebkitTapHighlightColor: 'transparent',
        userSelect: 'none',
        touchAction: 'manipulation' // Elimina el retardo de 300ms en algunos móviles
    },
